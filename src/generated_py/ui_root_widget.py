...
class Ui_root_widget(object):
    ...
    def retranslateUi(self, root_widget):
        ...
        self.input_doc_sec.setAccessibleName(QCoreApplication.translate("root_widget", u"<html><head/><body><p>Input Document's Widget Section</p></body></html>", None))
#endif // QT_CONFIG(accessibility)
#if QT_CONFIG(accessibility)
        self.input_doc_sec.setAccessibleDescription(QCoreApplication.translate("root_widget", u"<html><head/><body><p>Input Document's widget contains all the widgets that's used to set the input document.</p></body></html>", None))
#endif // QT_CONFIG(accessibility)
...
#if QT_CONFIG(accessibility)
        self.input_doc_format_cb.setAccessibleName(QCoreApplication.translate("root_widget", u"<html><head/><body><p>Input Document Format Dropdown List.</p></body></html>", None))
#endif // QT_CONFIG(accessibility)
#if QT_CONFIG(accessibility)
        self.input_doc_format_cb.setAccessibleDescription(QCoreApplication.translate("root_widget", u"<html><head/><body><p>This dropdown list can be used to select the format of the input document. Key shortcut is 'Ctrl+i'.</p></body></html>", None))
#endif // QT_CONFIG(accessibility)
        self.input_loc_lbl.setText(QCoreApplication.translate("root_widget", u"Location", None))
#if QT_CONFIG(accessibility)
        self.input_doc_browse_btn.setAccessibleName(QCoreApplication.translate("root_widget", u"<html><head/><body><p>Input Document selector button.</p></body></html>", None))
#endif // QT_CONFIG(accessibility)
#if QT_CONFIG(accessibility)
        self.input_doc_browse_btn.setAccessibleDescription(QCoreApplication.translate("root_widget", u"<html><head/><body><p>This button can be used to open the file explorer and select the input document of the format selected in the drop down list. Key shortcut is 'i'.</p></body></html>", None))
#endif // QT_CONFIG(accessibility)
        self.input_doc_browse_btn.setText(QCoreApplication.translate("root_widget", u"Browse...", None))
        self.input_doc_lbl.setText("")
#if QT_CONFIG(accessibility)
        self.output_doc_sec.setAccessibleName(QCoreApplication.translate("root_widget", u"<html><head/><body><p>Output Document's Widget Section</p></body></html>", None))
#endif // QT_CONFIG(accessibility)
#if QT_CONFIG(accessibility)
        self.output_doc_sec.setAccessibleDescription(QCoreApplication.translate("root_widget", u"<html><head/><body><p>Output Document's widget contains all the widgets that's used to set the output document.</p></body></html>", None))
#endif // QT_CONFIG(accessibility)
...
#if QT_CONFIG(accessibility)
        self.output_doc_format_cb.setAccessibleName(QCoreApplication.translate("root_widget", u"<html><head/><body><p>Output Document Format Dropdown List.</p></body></html>", None))
#endif // QT_CONFIG(accessibility)
#if QT_CONFIG(accessibility)
        self.output_doc_format_cb.setAccessibleDescription(QCoreApplication.translate("root_widget", u"<html><head/><body><p>This dropdown list can be used to select the format of the output document. Key shortcut is 'Ctrl+o'.</p></body></html>", None))
#endif // QT_CONFIG(accessibility)
        self.output_loc_lbl.setText(QCoreApplication.translate("root_widget", u"Location", None))
#if QT_CONFIG(accessibility)
        self.output_doc_browse_btn.setAccessibleName(QCoreApplication.translate("root_widget", u"<html><head/><body><p>Output Document setter button.</p></body></html>", None))
#endif // QT_CONFIG(accessibility)
#if QT_CONFIG(accessibility)
        self.output_doc_browse_btn.setAccessibleDescription(QCoreApplication.translate("root_widget", u"<html><head/><body><p>This button can be used to open the file explorer and set the output document of the format selected in the drop down list. The user'll have to navigate to the desired location and give a name for the resulting document. Key shortcut is 'o'.</p></body></html>", None))
#endif // QT_CONFIG(accessibility)
        self.output_doc_browse_btn.setText(QCoreApplication.translate("root_widget", u"Browse...", None))
        self.output_doc_lbl.setText("")
#if QT_CONFIG(accessibility)
        self.convert_btn.setAccessibleName(QCoreApplication.translate("root_widget", u"<html><head/><body><p>Convert button</p></body></html>", None))
#endif // QT_CONFIG(accessibility)
#if QT_CONFIG(accessibility)
        self.convert_btn.setAccessibleDescription(QCoreApplication.translate("root_widget", u"<html><head/><body><p>Clicking this button will start converting the selected document and create the output document specified by the user. Key shortcut is 'c'.</p></body></html>", None))
#endif // QT_CONFIG(accessibility)
